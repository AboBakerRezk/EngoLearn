...
final List<Map<String, String>> allWords2 = [
  ...
  {'word': 'but', 'translation': 'لكن', 'image': '⚖️'}, // ميزان (يشير للمقارنة)
  ...
  {'word': 'they', 'translation': 'هم', 'image': '👥'}, // شخصين (للدلالة على الجمع)
  {'word': 'more', 'translation': 'أكثر', 'image': '➕'}, // علامة زائد (أكثر)

  {'word': 'will', 'translation': 'سوف', 'image': '⏳'}, // ساعة رملية تشير للمستقبل
  {'word': 'if', 'translation': 'إذا', 'image': '❓'}, // علامة استفهام
  {'word': 'some', 'translation': 'بعض', 'image': '📊'}, // رسم بياني (يعبر عن بعض البيانات)
  {'word': 'there', 'translation': 'هناك', 'image': '📍'}, // دبوس موقع
  {'word': 'what', 'translation': 'ماذا', 'image': '❔'}, // علامة استفهام بيضاء

  {'word': 'about', 'translation': 'حول', 'image': '🔄'}, // سهم دائري يشير للتفاصيل
  {'word': 'which', 'translation': 'التي', 'image': '❓'}, // علامة استفهام (للدلالة على الاختيار)
  {'word': 'when', 'translation': 'متى', 'image': '⏰'}, // ساعة للدلالة على الوقت
