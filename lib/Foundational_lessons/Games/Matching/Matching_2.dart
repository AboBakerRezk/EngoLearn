...
class QuickMatchGame2 extends StatefulWidget {
  @override
  _QuickMatchGame2State createState() => _QuickMatchGame2State();
}

class _QuickMatchGame2State extends State<QuickMatchGame2> {
