...
class QuickMatchGame7 extends StatefulWidget {
  @override
  _QuickMatchGame7State createState() => _QuickMatchGame7State();
}

class _QuickMatchGame7State extends State<QuickMatchGame7> {
