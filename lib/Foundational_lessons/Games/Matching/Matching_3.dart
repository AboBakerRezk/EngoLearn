...
class QuickMatchGame3 extends StatefulWidget {
  @override
  _QuickMatchGame3State createState() => _QuickMatchGame3State();
}

class _QuickMatchGame3State extends State<QuickMatchGame3> {
