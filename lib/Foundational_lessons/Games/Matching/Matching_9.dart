...
class QuickMatchGame9 extends StatefulWidget {
  @override
  _QuickMatchGame9State createState() => _QuickMatchGame9State();
}

class _QuickMatchGame9State extends State<QuickMatchGame9> {
