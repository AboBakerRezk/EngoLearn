...
class QuickMatchGame6 extends StatefulWidget {
  @override
  _QuickMatchGame6State createState() => _QuickMatchGame6State();
}

class _QuickMatchGame6State extends State<QuickMatchGame6> {
