...
class QuickMatchGame8 extends StatefulWidget {
  @override
  _QuickMatchGame8State createState() => _QuickMatchGame8State();
}

class _QuickMatchGame8State extends State<QuickMatchGame8> {
