...
class QuickMatchGame1 extends StatefulWidget {
  @override
  _QuickMatchGame1State createState() => _QuickMatchGame1State();
}

class _QuickMatchGame1State extends State<QuickMatchGame1> {
