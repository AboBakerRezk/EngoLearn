...
class QuickMatchGame4 extends StatefulWidget {
  @override
  _QuickMatchGame4State createState() => _QuickMatchGame4State();
}

class _QuickMatchGame4State extends State<QuickMatchGame4> {
