...
class QuickMatchGame5 extends StatefulWidget {
  @override
  _QuickMatchGame5State createState() => _QuickMatchGame5State();
}

class _QuickMatchGame5State extends State<QuickMatchGame5> {
