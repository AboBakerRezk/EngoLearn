...
final List<Map<String, String>> allWords2 = [
  // المجموعة الأولى
  {'word': 'this', 'translation': 'هذا', 'image': '👆'},
  {'word': 'an', 'translation': 'أ', 'image': '🔤'},
  {'word': 'by', 'translation': 'بواسطة', 'image': '✍️'},
  {'word': 'not', 'translation': 'ليس', 'image': '🚫'},
  {'word': 'but', 'translation': 'لكن', 'image': '⚖️'},

  // المجموعة الثانية
  {'word': 'at', 'translation': 'في', 'image': '📍'},
  {'word': 'from', 'translation': 'من', 'image': '↩️'},
  {'word': 'I', 'translation': 'أنا', 'image': '🙋'},
  {'word': 'they', 'translation': 'هم', 'image': '👥'},
  {'word': 'more', 'translation': 'أكثر', 'image': '➕'},

  // المجموعة الثالثة
  {'word': 'will', 'translation': 'سوف', 'image': '🔜'},
  {'word': 'if', 'translation': 'إذا', 'image': '❓'},
  {'word': 'some', 'translation': 'بعض', 'image': '🔸'},
  {'word': 'there', 'translation': 'هناك', 'image': '📍'},
  {'word': 'what', 'translation': 'ماذا', 'image': '❔'},

  // المجموعة الرابعة
  {'word': 'about', 'translation': 'حول', 'image': '🔄'},
  {'word': 'which', 'translation': 'التي', 'image': '❓'},
  {'word': 'when', 'translation': 'متى', 'image': '⏰'},
  {'word': 'one', 'translation': 'واحد', 'image': '1️⃣'},
  {'word': 'their', 'translation': 'لهم', 'image': '👫'},
];
...
class MatchWordToImagePage2 extends StatefulWidget {
  @override
  _MatchWordToImagePage2State createState() => _MatchWordToImagePage2State();
}

class _MatchWordToImagePage2State extends State<MatchWordToImagePage2>
