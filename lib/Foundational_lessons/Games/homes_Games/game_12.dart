...
import '../Correction/Correction_12.dart';
import '../Difficult_translation/Difficult_translation_12.dart';
import '../Fill_in_the_blanks/Fill_in_the_blanks_12.dart';
import '../Guess/Guess_12.dart';
import '../Listening/Listening_12.dart';
import '../Matching/Matching_12.dart';
import '../Memory/Memory_12.dart';
import '../Translation/Translation_12.dart';
import '../the order of letters/the order of letters_12.dart';
...
class HomeGame12 extends StatefulWidget {
  @override
  _HomeGame12State createState() => _HomeGame12State();
}

class _HomeGame12State extends State<HomeGame12>
          ...
          child: ListView(
            ...
            children: [
              _buildButton('${AppLocale.S80.getString(context)}', () {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => translation12()),
                );               }),
              SizedBox(height: 20),
              ...
              _buildButton('${AppLocale.Ss80.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => translationd12()),
                );               }),
              SizedBox(height: 20),
////////////////////
              _buildButton('${AppLocale.S85.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => FillInTheBlanksPage12()),
                );               }),
              SizedBox(height: 20),
              ////////////////////
              _buildButton('${AppLocale.S104.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MatchWordToImagePage12()),
                );               }),
              SizedBox(height: 20),
              ////////////////////
              _buildButton('${AppLocale.S108.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => RearrangeLettersPage12()),
                );               }),
              SizedBox(height: 20),
              ////////////////////
              _buildButton('${AppLocale.S114.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => MemoryGamePage12()),
                );               }),
              SizedBox(height: 20),
              ////////////////////
              _buildButton('${AppLocale.S115.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => WordShootingGame12()),
                );               }),
              SizedBox(height: 20),
              ////////////////////
              _buildButton('${AppLocale.S117.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => QuickMatchGame12()),
                );               }),
              SizedBox(height: 20),
              _buildButton('${AppLocale.S118.getString(context)}', () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => ListeningGame12()),
                );               }),
              SizedBox(height: 20),
            ],
          ),
