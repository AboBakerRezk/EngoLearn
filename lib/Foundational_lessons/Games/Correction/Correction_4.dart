...
class WordShootingGame4 extends StatefulWidget {
  @override
  _WordShootingGame4State createState() => _WordShootingGame4State();
}

class _WordShootingGame4State extends State<WordShootingGame4> {
  // Points Variables
