...
class WordShootingGame18 extends StatefulWidget {
  @override
  _WordShootingGame18State createState() => _WordShootingGame18State();
}

class _WordShootingGame18State extends State<WordShootingGame18>{
  // Points Variables
