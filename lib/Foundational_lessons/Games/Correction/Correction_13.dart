...
class WordShootingGame13 extends StatefulWidget {
  @override
  _WordShootingGame13State createState() => _WordShootingGame13State();
}

class _WordShootingGame13State extends State<WordShootingGame13> {
  // Points Variables
