...
class WordShootingGame11 extends StatefulWidget {
  @override
  _WordShootingGame11State createState() => _WordShootingGame11State();
}

class _WordShootingGame11State extends State<WordShootingGame11> {
  // Points Variables
