...
class WordShootingGame3 extends StatefulWidget {
  @override
  _WordShootingGame3State createState() => _WordShootingGame3State();
}

class _WordShootingGame3State extends State<WordShootingGame3> {
  // Points Variables
