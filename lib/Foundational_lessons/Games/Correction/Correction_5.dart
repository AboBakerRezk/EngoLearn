...
class WordShootingGame5 extends StatefulWidget {
  @override
  _WordShootingGame5State createState() => _WordShootingGame5State();
}

class _WordShootingGame5State extends State<WordShootingGame5> {
  // Points Variables
