...
class WordShootingGame15 extends StatefulWidget {
  @override
  _WordShootingGame15State createState() => _WordShootingGame15State();
}

class _WordShootingGame15State extends State<WordShootingGame15>{
  // Points Variables
