...
class WordShootingGame10 extends StatefulWidget {
  @override
  _WordShootingGame10State createState() => _WordShootingGame10State();
}

class _WordShootingGame10State extends State<WordShootingGame10> {
  // Points Variables
