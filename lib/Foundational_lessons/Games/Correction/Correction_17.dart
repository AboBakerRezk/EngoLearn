...
class WordShootingGame17 extends StatefulWidget {
  @override
  _WordShootingGame17State createState() => _WordShootingGame17State();
}

class _WordShootingGame17State extends State<WordShootingGame17>{
  // Points Variables
