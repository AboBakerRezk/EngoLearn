...
class WordShootingGame20 extends StatefulWidget {
  @override
  _WordShootingGame20State createState() => _WordShootingGame20State();
}

class _WordShootingGame20State extends State<WordShootingGame20> {
  // Points Variables
