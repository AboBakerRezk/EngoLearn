...
class WordShootingGame12 extends StatefulWidget {
  @override
  _WordShootingGame12State createState() => _WordShootingGame12State();
}

class _WordShootingGame12State extends State<WordShootingGame12>  {
  // Points Variables
