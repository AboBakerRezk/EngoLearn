...
class WordShootingGame24 extends StatefulWidget {
  @override
  _WordShootingGame24State createState() => _WordShootingGame24State();
}

class _WordShootingGame24State extends State<WordShootingGame24>  {
  // Points Variables
