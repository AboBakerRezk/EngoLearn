...
class WordShootingGame25 extends StatefulWidget {
  @override
  _WordShootingGame25State createState() => _WordShootingGame25State();
}

class _WordShootingGame25State extends State<WordShootingGame25>  {
  // Points Variables
