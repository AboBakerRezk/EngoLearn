...
class WordShootingGame21 extends StatefulWidget {
  @override
  _WordShootingGame21State createState() => _WordShootingGame21State();
}

class _WordShootingGame21State extends State<WordShootingGame21>{
  // Points Variables
