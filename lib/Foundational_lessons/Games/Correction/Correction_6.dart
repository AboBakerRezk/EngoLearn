...
class WordShootingGame6 extends StatefulWidget {
  @override
  _WordShootingGame6State createState() => _WordShootingGame6State();
}

class _WordShootingGame6State extends State<WordShootingGame6>  {
  // Points Variables
