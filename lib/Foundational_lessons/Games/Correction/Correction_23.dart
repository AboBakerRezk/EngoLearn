...
class WordShootingGame23 extends StatefulWidget {
  @override
  _WordShootingGame23State createState() => _WordShootingGame23State();
}

class _WordShootingGame23State extends State<WordShootingGame23>  {
  // Points Variables
