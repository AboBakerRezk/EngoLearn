...
class WordShootingGame22 extends StatefulWidget {
  @override
  _WordShootingGame22State createState() => _WordShootingGame22State();
}

class _WordShootingGame22State extends State<WordShootingGame22> {
  // Points Variables
