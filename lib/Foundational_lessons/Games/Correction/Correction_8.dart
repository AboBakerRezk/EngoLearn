...
class WordShootingGame8 extends StatefulWidget {
  @override
  _WordShootingGame8State createState() => _WordShootingGame8State();
}

class _WordShootingGame8State extends State<WordShootingGame8>  {
  // Points Variables
