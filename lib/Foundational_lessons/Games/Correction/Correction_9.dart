...
class WordShootingGame9 extends StatefulWidget {
  @override
  _WordShootingGame9State createState() => _WordShootingGame9State();
}

class _WordShootingGame9State extends State<WordShootingGame9> {
  // Points Variables
