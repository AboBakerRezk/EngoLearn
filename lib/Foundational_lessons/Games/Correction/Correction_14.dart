...
class WordShootingGame14 extends StatefulWidget {
  @override
  _WordShootingGame14State createState() => _WordShootingGame14State();
}

class _WordShootingGame14State extends State<WordShootingGame14> {
  // Points Variables
