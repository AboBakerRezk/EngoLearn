...
class WordShootingGame19 extends StatefulWidget {
  @override
  _WordShootingGame19State createState() => _WordShootingGame19State();
}

class _WordShootingGame19State extends State<WordShootingGame19>{
  // Points Variables
