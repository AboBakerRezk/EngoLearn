...
class WordShootingGame2 extends StatefulWidget {
  @override
  _WordShootingGame2State createState() => _WordShootingGame2State();
}

class _WordShootingGame2State extends State<WordShootingGame2>  {
  // Points Variables
