...
class WordShootingGame7 extends StatefulWidget {
  @override
  _WordShootingGame7State createState() => _WordShootingGame7State();
}

class _WordShootingGame7State extends State<WordShootingGame7>{
  // Points Variables
