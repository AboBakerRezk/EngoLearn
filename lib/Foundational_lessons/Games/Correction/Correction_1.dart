...
class WordShootingGame1 extends StatefulWidget {
  @override
  _WordShootingGame1State createState() => _WordShootingGame1State();
}

class _WordShootingGame1State extends State<WordShootingGame1> {
  // Points Variables
