...
class MemorizationPage2 extends StatefulWidget {
  @override
  _MemorizationPage2State createState() => _MemorizationPage2State();
}

class _MemorizationPage2State extends State<MemorizationPage2> {
