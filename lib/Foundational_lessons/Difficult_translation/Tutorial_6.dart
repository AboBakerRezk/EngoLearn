...
class MemorizationPage6 extends StatefulWidget {
  @override
  _MemorizationPage6State createState() => _MemorizationPage6State();
}

class _MemorizationPage6State extends State<MemorizationPage6> {
