...
class MemorizationPage21 extends StatefulWidget {
  @override
  _MemorizationPage21State createState() => _MemorizationPage21State();
}

class _MemorizationPage21State extends State<MemorizationPage21> {
  ...
  final List<List<String>> allImages = [
    ...
    [
      ...
      'assets/rather.png',
      'assets/access.png',
      'assets/additional.png',
    ],
    [
      'assets/almost.png',
      'assets/especially.png',
      'assets/garden.png',
