...
class MemorizationPage15 extends StatefulWidget {
  @override
  _MemorizationPage15State createState() => _MemorizationPage15State();
}

class _MemorizationPage15State extends State<MemorizationPage15> {
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          ...['The cat is on the mat.', 'The cat mat is the on.', 'Cat is the on mat.']
              .map((sentence) {
            return ListTile(
              title: Text(
                sentence,
