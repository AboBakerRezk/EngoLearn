...
class MemorizationPage4 extends StatefulWidget {
  @override
  _MemorizationPage4State createState() => _MemorizationPage4State();
}

class _MemorizationPage4State extends State<MemorizationPage4> {
