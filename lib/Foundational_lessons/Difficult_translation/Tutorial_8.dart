...
class MemorizationPage8 extends StatefulWidget {
  @override
  _MemorizationPage8State createState() => _MemorizationPage8State();
}

class _MemorizationPage8State extends State<MemorizationPage8> {
