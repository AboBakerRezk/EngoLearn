...
import 'package:audioplayers/audioplayers.dart'; // إضافة المكتبة لتشغيل الصوت

class MemorizationPage9 extends StatefulWidget {
  @override
  _MemorizationPage9State createState() => _MemorizationPage9State();
}

class _MemorizationPage9State extends State<MemorizationPage9> {
