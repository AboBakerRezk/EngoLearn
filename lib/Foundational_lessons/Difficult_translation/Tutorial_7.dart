...
class MemorizationPage7 extends StatefulWidget {
  @override
  _MemorizationPage7State createState() => _MemorizationPage7State();
}

class _MemorizationPage7State extends State<MemorizationPage7> {
