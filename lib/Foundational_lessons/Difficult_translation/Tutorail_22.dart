...
import 'package:audioplayers/audioplayers.dart'; // مكتبة لتشغيل الصوت

class MemorizationPage22 extends StatefulWidget {
  @override
  _MemorizationPage22State createState() => _MemorizationPage22State();
}

class _MemorizationPage22State extends State<MemorizationPage22> {
  ...
  final List<List<String>> allImages = [
    ...
    [
      'assets/above.png',
      'assets/according.png',
      'assets/cook.png',
      'assets/determine.png',
      'assets/future.png',
    ],
    [
      'assets/site.png',
