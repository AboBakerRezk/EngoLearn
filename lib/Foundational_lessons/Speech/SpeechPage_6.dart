...
class SpeechPage6 extends StatefulWidget {
  @override
  _SpeechPage6State createState() => _SpeechPage6State();
}

class _SpeechPage6State extends State<SpeechPage6> with SingleTickerProviderStateMixin {
