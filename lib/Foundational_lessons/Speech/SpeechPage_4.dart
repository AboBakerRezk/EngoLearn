...
class SpeechPage4 extends StatefulWidget {
  @override
  _SpeechPage4State createState() => _SpeechPage4State();
}

class _SpeechPage4State extends State<SpeechPage4> with SingleTickerProviderStateMixin {
