...
class SpeechPage5 extends StatefulWidget {
  @override
  _SpeechPage5State createState() => _SpeechPage5State();
}

class _SpeechPage5State extends State<SpeechPage5> with SingleTickerProviderStateMixin {
