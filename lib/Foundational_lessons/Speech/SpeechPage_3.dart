...
class SpeechPage3 extends StatefulWidget {
  @override
  _SpeechPage3State createState() => _SpeechPage3State();
}

class _SpeechPage3State extends State<SpeechPage3> with SingleTickerProviderStateMixin {
