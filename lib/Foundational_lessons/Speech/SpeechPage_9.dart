...
class SpeechPage9 extends StatefulWidget {
  @override
  _SpeechPage9State createState() => _SpeechPage9State();
}

class _SpeechPage9State extends State<SpeechPage9> with SingleTickerProviderStateMixin {
