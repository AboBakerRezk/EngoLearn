...
class SpeechPage7 extends StatefulWidget {
  @override
  _SpeechPage7State createState() => _SpeechPage7State();
}

class _SpeechPage7State extends State<SpeechPage7> with SingleTickerProviderStateMixin {
