...
class ReadingAssessmentPage9 extends StatefulWidget {
  @override
  _ReadingAssessmentPage9State createState() => _ReadingAssessmentPage9State();
}

class _ReadingAssessmentPage9State extends State<ReadingAssessmentPage9>    with SingleTickerProviderStateMixin {
...
class ReadingData {
  ...
  static final List<String> readingTexts = [
    ...
    // القصة الجديدة
    '''
    Omar was excited about the school science fair. He decided to make a volcano model. He used baking soda and vinegar to create the eruption effect. On the day of the fair, everyone gathered around to watch. When he poured the vinegar, the volcano erupted with colorful foam. Omar felt proud and happy when he received a prize for his creative project.
    '''
  ];
  ...
  static final List<List<ReadingQuestion>> questionsList = [
    ...
    [
      ReadingQuestion(
        questionText: "1. What project did Omar make for the science fair?",
        options: ["A robot", "A volcano model", "A spaceship", "A flower garden"],
        correctAnswer: "A volcano model",
        hint: "He used baking soda and vinegar.",
      ),
      ReadingQuestion(
        questionText: "2. What did Omar use to create the eruption?",
        options: ["Water and sand", "Baking soda and vinegar", "Glue and paint", "Sugar and salt"],
        correctAnswer: "Baking soda and vinegar",
        hint: "These ingredients made the volcano erupt.",
      ),
      ReadingQuestion(
        questionText: "3. How did Omar feel after winning the prize?",
        options: ["Sad", "Angry", "Proud", "Tired"],
        correctAnswer: "Proud",
        hint: "He was happy with his creative project.",
      ),
    ],
  ];
}
