...
class ReadingAssessmentPage23 extends StatefulWidget {
  @override
  _ReadingAssessmentPage23State createState() => _ReadingAssessmentPage23State();
}

class _ReadingAssessmentPage23State extends State<ReadingAssessmentPage23>
...
class ReadingData {
  ...
  static final List<String> readingTexts = [
    '''
    Omar loves animals very much. He has a pet cat named Whiskers. One day, Omar found a small bird on the ground. The bird had fallen from its nest. Omar felt sad for the bird and decided to help it. He carefully picked it up and took it home. Omar and his mother made a cozy bed for the bird using a box and some soft cloth. They fed the bird some seeds and gave it water. After a few days, the bird became strong enough to fly. Omar took it outside and watched it fly back to its nest. He felt happy to help the little bird.
    '''
  ];
  ...
  static final List<List<ReadingQuestion>> questionsList = [
    [
      ReadingQuestion(
        questionText: "1. What is the name of Omar's pet?",
        options: ["Buddy", "Whiskers", "Charlie", "Max"],
        correctAnswer: "Whiskers",
        hint: "He has a pet cat named this.",
      ),
      ReadingQuestion(
        questionText: "2. What did Omar find on the ground?",
        options: ["A dog", "A cat", "A bird", "A rabbit"],
        correctAnswer: "A bird",
        hint: "It had fallen from its nest.",
      ),
      ReadingQuestion(
        questionText: "3. How did Omar feel when he found the bird?",
        options: ["Happy", "Sad", "Angry", "Excited"],
        correctAnswer: "Sad",
        hint: "He felt sad for the bird.",
      ),
      ReadingQuestion(
        questionText: "4. What did Omar and his mother make for the bird?",
        options: ["A cage", "A cozy bed", "A nest", "A toy"],
        correctAnswer: "A cozy bed",
        hint: "They used a box and some soft cloth.",
      ),
      ReadingQuestion(
        questionText: "5. What did Omar do when the bird became strong?",
        options: ["He kept it as a pet", "He took it to the vet", "He watched it fly back to its nest", "He fed it more seeds"],
        correctAnswer: "He watched it fly back to its nest",
        hint: "He helped the bird go home.",
      ),
    ]
  ];
}
