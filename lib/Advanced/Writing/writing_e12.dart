...
class WritingSections12 extends StatefulWidget {
  @override
  _WritingSections12State createState() => _WritingSections12State();
}

class _WritingSections12State extends State<WritingSections12> {
  ...
  String title = ' A Difficult Decision I Had to Make'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'choice', 'decision', 'struggle', 'conflict', 'dilemma', 'challenge', 'sacrifice', 'uncertainty', 'risk',
    'responsibility', 'weighing', 'options', 'fear', 'doubt', 'hesitation', 'pressure', 'consequences', 'cost',
    'judgment', 'consideration', 'balance', 'outcome', 'regret', 'emotions', 'stress', 'difficult', 'painful',
    'discomfort', 'disappointment', 'hope', 'trust', 'patience', 'resolve', 'faith', 'instinct', 'reason',
    'solution', 'facing', 'understanding', 'clarity', 'growth', 'courage', 'struggle', 'obligation', 'personal',
    'experience', 'determination', 'reflection', 'choice', 'challenge', 'hard', 'weigh', 'impact', 'regret',
    'tough', 'sacrifice', 'compromise', 'learning', 'self-reflection', 'consider', 'evaluate', 'difficult',
    'impactful', 'weighing', 'choices', 'outcome', 'direction', 'long-term', 'balance', 'pressure', 'growth',
