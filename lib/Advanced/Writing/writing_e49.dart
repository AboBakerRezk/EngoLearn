...
class WritingSection49 extends StatefulWidget {
  @override
  _WritingSection49State createState() => _WritingSection49State();
}

class _WritingSection49State extends State<WritingSection49>    with SingleTickerProviderStateMixin {
  // Variables
  String userWriting = '';
...
// Function to save progress levels including bottleFillLevel to SharedPreferences
  ...
  void _checkRelevance() {
    List<String> topicKeywords = [
      // الكلمات المتعلقة بمستقبل العمل: العمل عن بُعد مقابل المكاتب التقليدية:
      'future of work',
      'remote work',
      'traditional offices',
      'hybrid work model',
      ...
      'employee satisfaction in remote work',
      ...
      'virtual onboarding',
      'workplace inclusivity in remote work',
      'traditional office limitations',
      ...
      'workplace tech for remote work',
      'office networking',
      'remote team engagement',
      'remote onboarding process',
      'future of corporate offices',
      'office-based networking',
      'remote work equality',
      ...
      'office environment trends',
      'workplace efficiency',
      'remote work employee motivation',
      'office work flexibility',
      'virtual team leadership',
      'remote work innovation tools',
      'digital workspace',
      'remote work digital tools',
      'remote work and office integration',
      'office productivity management',
      'remote job performance',
      'in-person vs virtual meetings',
      'remote team productivity',
      'office work autonomy',
      ...
      'office dynamics in hybrid work',
      'remote work expectations management',
      'in-person collaboration benefits',
      'remote work adaptability',
      'office work culture evolution',
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            SizedBox(height: 20),
            Text(
              ' The Future of Work: Remote vs. Traditional Offices.',
