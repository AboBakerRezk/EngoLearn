...
class WritingSections22 extends StatefulWidget {
  @override
  _WritingSections22State createState() => _WritingSections22State();
}

class _WritingSections22State extends State<WritingSections22> {
  ...
  String title = 'The Impact of Failure on Success'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'resilience', 'growth', 'learning', 'experience', 'overcoming', 'determination', 'insight', 'adaptation',
    'perseverance', 'challenges', 'reflection', 'improvement', 'motivation', 'strength', 'courage',
    'transformation', 'failure', 'success', 'insight', 'character', 'innovation', 'mindset', 'embracing',
    'opportunity', 'tenacity', 'struggle', 'feedback', 'realization', 'commitment', 'persistence',
    'self-discovery', 'achievement', 'journey', 'attitude', 'responsibility', 'patience',
    'lessons', 'evolution', 'nurturing', 'vision', 'breakthrough', 'drive', 'empowerment',
    'self-improvement', 'change', 'perception', 'analysis', 'reflection', 'forward',
    'goal', 'focus', 'adaptability', 'resourcefulness', 'success', 'motivation'
  ];
