...
class WritingSections17 extends StatefulWidget {
  @override
  _WritingSections17State createState() => _WritingSections17State();
}

class _WritingSections17State extends State<WritingSections17> {
  ...
  String title = 'A Challenge I Overcame'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'perseverance', 'resilience', 'growth', 'strength', 'determination', 'obstacle', 'success', 'struggle',
    'overcome', 'persistence', 'courage', 'learning', 'support', 'motivation', 'confidence', 'commitment',
    'journey', 'triumph', 'goal', 'hardship', 'inspiration', 'tenacity', 'mindset', 'grit', 'hope',
    'adaptability', 'focus', 'failure', 'victory', 'endurance', 'experience', 'reflection', 'self-discovery',
    'transformation', 'achievement', 'challenge', 'resolve', 'character', 'insight', 'dedication',
    'support', 'empowerment', 'change', 'commitment', 'emotional', 'resolve', 'growth',
    'resilience', 'bravery', 'determination', 'hard work', 'success', 'learning', 'overcoming',
    'confrontation', 'effort', 'skills', 'problem-solving', 'determination', 'advancement'
  ];
