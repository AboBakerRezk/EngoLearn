...
class WritingSections14 extends StatefulWidget {
  @override
  _WritingSections14State createState() => _WritingSections14State();
}

class _WritingSections14State extends State<WritingSections14> {
  ...
  String title = ' The Impact of Technology on Our Lives'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'innovation', 'advancement', 'communication', 'connectivity', 'transformation', 'efficiency', 'automation',
    'information', 'accessibility', 'creativity', 'development', 'education', 'society', 'globalization', 'impact',
    'digital', 'lifestyle', 'adaptation', 'smart technology', 'AI', 'social media', 'integration', 'collaboration',
    'productivity', 'healthcare', 'entertainment', 'sustainability', 'convenience', 'relationships', 'disruption',
    'privacy', 'security', 'data', 'innovation', 'tools', 'mobility', 'consumerism', 'information overload',
    'virtual', 'experience', 'technological literacy', 'ethics', 'emerging technologies', 'resources', 'global',
    'community', 'future', 'challenges', 'opportunities', 'perspectives', 'changes', 'influence', 'connectivity',
    'evolution', 'transparency', 'quality of life', 'responsibility', 'engagement', 'work-life balance', 'interdependence',
    'contribution', 'enhancement', 'technology-driven', 'exploration', 'solution'
  ];
