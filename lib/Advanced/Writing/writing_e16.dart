...
class WritingSections16 extends StatefulWidget {
  @override
  _WritingSections16State createState() => _WritingSections16State();
}

class _WritingSections16State extends State<WritingSections16> {
  ...
  String title = ' A Hobby That Helps Me Relax'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'relaxation', 'leisure', 'stress relief', 'enjoyment', 'creativity', 'mindfulness', 'meditation', 'art',
    'crafting', 'reading', 'nature', 'walking', 'gardening', 'music', 'painting', 'writing', 'hiking',
    'exercise', 'yoga', 'photography', 'baking', 'cooking', 'travel', 'exploration', 'focusing', 'hobby',
    'peace', 'tranquility', 'balance', 'self-care', 'fun', 'escapism', 'serenity', 'connection',
    'community', 'routine', 'rejuvenation', 'spirituality', 'adventure', 'play', 'enjoyment',
    'reflection', 'exploration', 'cooking', 'crafting', 'fitness', 'active', 'socializing',
    'games', 'puzzles', 'mindset', 'harmony', 'expression', 'time', 'joy', 'skills',
    'connection', 'healing', 'nostalgia', 'freedom', 'discovery', 'happiness'
  ];
