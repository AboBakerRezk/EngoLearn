...
class WritingSection46 extends StatefulWidget {
  @override
  _WritingSection46State createState() => _WritingSection46State();
}

class _WritingSection46State extends State<WritingSection46>    with SingleTickerProviderStateMixin {
  // Variables
  String userWriting = '';
...
// Function to save progress levels including bottleFillLevel to SharedPreferences
  ...
  void _checkRelevance() {
    List<String> topicKeywords = [
      // الكلمات المتعلقة بدور الفن في التغيير الاجتماعي:
      ...
      'art and public awareness',
      'art and global movements',
      'art as social critique',
      'art for societal reflection',
      'cultural resistance',
      'art and political critique',
      'art and human dignity',
      'art for peace',
      'art and justice movements',
      'art and refugee crisis',
      'art for solidarity',
      'art and cultural identity',
      'art for social inclusion',
      'political performance art',
      'art and revolution movements',
      'art and empathy',
      'art and power dynamics',
      'art for social equity',
      'art and social justice initiatives',
      'art and immigration issues',
      'art and public spaces',
      'art and transformative justice',
      'art and LGBTQ+ activism',
      'art for change',
      'art and diversity',
      'art for community empowerment',
      'art for peacebuilding',
      'art and human rights advocacy',
      'art and social critique',
      'art for civic engagement',
      'art in social justice campaigns',
      'art and social change movements',
      'art and education reform',
      'art for mental health awareness',
      'art for minority voices',
      'art and societal change',
      'art and nonviolent resistance',
      'art and political awareness',
      'art for raising consciousness',
      'art and cultural diplomacy',
      'art and poverty awareness',
      'art and global justice',
      'art for climate justice',
      'art and indigenous rights',
      'art for refugee awareness',
      'art for cultural preservation',
      'art and historical memory',
      'art for social progress',
      'art for racial equality',
      'art and ethical issues',
      'art and social critique movements',
      'art and societal reform',
      'art and urban change',
      'art for public dialogue',
      'art for marginalized communities',
      'art and economic inequality',
      'art and human rights movements',
      'art for freedom',
      'art for social empowerment',
      'art and labor rights',
      'art and youth activism',
      'art and political change',
      'art and civil rights movements',
      'art and social engagement',
      'art and political consciousness',
      'art and cultural movements',
      'art and global activism',
      'art and resistance movements',
      'art and political resistance',
      'art and freedom movements',
      'art and the fight for justice',
      'art as a form of activism',
      'art and social revolution',
      'art and awareness campaigns',
      'art for progressive change',
      'art and community activism',
      'art and collective action',
      'art and human rights violations',
      'art and women’s rights movements',
      'art for public education',
      'art and cultural shifts',
      'art and civil discourse',
      'art and global consciousness',
      'art for a better world',
      'art and ethical activism',
      'art and empowerment movements',
      'art as a medium for change',
      'art and education for change',
      'art and public action',
      'art for inclusive change',
      'art and political struggles',
      'art and advocacy',
      'art and societal reflection',
      'art and transformative movements',
      'art and cultural challenges',
      'art and community building',
      'art for global awareness',
      'art for breaking barriers',
      'art and social reform',
      'art for activism and protest',
      'art and the fight for equality',
      'art and political discourse',
      'art and consciousness raising',
      'art for environmental justice',
      'art and urban activism',
      'art for societal change',
      'art for human connection',
      'art and social justice campaigns',
      'art and peace movements',
      'art and public protest',
      'art and revolutionaries',
      'art and social innovation',
      'art for awareness and change',
      'art for creating dialogue',
      'art and transformative cultural movements',
      'art for underrepresented voices',
      'art and radical change',
      'art and equality movements',
      'art for social healing',
      'art for breaking stereotypes',
      'art and the fight for equity',
      'art and political empowerment',
      'art and revolutionaries movements',
      'art and cultural transformation',
      'art and change makers',
      'art and political expression',
      'art for raising awareness on social issues',
      'art for social reform movements',
      'art and peace activism',
      'art and the fight for social change',
      'art and movement building',
      'art for the voiceless',
      'art and equality for all',
    ];
