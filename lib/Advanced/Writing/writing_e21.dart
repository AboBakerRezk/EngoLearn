...
class WritingSections21 extends StatefulWidget {
  @override
  _WritingSections21State createState() => _WritingSections21State();
}

class _WritingSections21State extends State<WritingSections21> {
  ...
  String title = 'The Journey of Self-Discovery'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'exploration', 'reflection', 'growth', 'identity', 'awareness', 'transformation', 'insight', 'experience',
    'understanding', 'discovery', 'authenticity', 'introspection', 'learning', 'change', 'freedom',
    'purpose', 'emotional', 'self-awareness', 'journey', 'values', 'embrace', 'acceptance', 'courage',
    'fulfillment', 'strength', 'challenges', 'clarity', 'mindfulness', 'connection', 'values', 'perspective',
    'passion', 'wisdom', 'nurturing', 'healing', 'self-reflection', 'choices', 'direction', 'motivation',
    'resilience', 'openness', 'emotional health', 'relationship', 'potential', 'evolution', 'journey',
    'self-acceptance', 'empowerment', 'individuality', 'growth', 'inner peace', 'expression',
    'life lessons', 'discovery', 'exploration', 'transformation', 'expansion', 'awakening'
  ];
