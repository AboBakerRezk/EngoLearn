...
class WritingSections20 extends StatefulWidget {
  @override
  _WritingSections20State createState() => _WritingSections20State();
}

class _WritingSections20State extends State<WritingSections20> {
  ...
  String title = 'How I Handle Stress in My Life'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'coping', 'strategies', 'mindfulness', 'relaxation', 'exercise', 'balance', 'breathing', 'self-care',
    'awareness', 'management', 'resilience', 'focus', 'meditation', 'journaling', 'time management',
    'support', 'boundaries', 'positive thinking', 'hobbies', 'nature', 'reflection', 'gratitude',
    'socializing', 'routine', 'distraction', 'prioritization', 'adaptability', 'emotional health',
    'stress relief', 'self-awareness', 'problem-solving', 'skills', 'acceptance', 'nurturing',
    'engagement', 'perspective', 'empathy', 'community', 'support systems', 'self-discipline',
    'tranquility', 'mental clarity', 'creativity', 'planning', 'commitment', 'flexibility',
    'detachment', 'peace', 'positivity', 'learning', 'tolerance', 'healing', 'joy',
    'mindset', 'control'
  ];
