...
class WritingSections15 extends StatefulWidget {
  @override
  _WritingSections15State createState() => _WritingSections15State();
}

class _WritingSections15State extends State<WritingSections15> {
  ...
  String title = 'A Trip That Changed My Perspective'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'journey', 'exploration', 'discovery', 'culture', 'experience', 'transformation', 'insight', 'adventure',
    'reflection', 'awakening', 'understanding', 'diversity', 'connection', 'memories', 'growth', 'perspective',
    'change', 'openness', 'mindfulness', 'learning', 'encounter', 'people', 'environment', 'nature', 'landscape',
    'adventure', 'challenges', 'newness', 'inspiration', 'wonder', 'exposure', 'perspectives', 'friendship',
    'life-changing', 'emotional', 'connection', 'value', 'impact', 'serendipity', 'adventure', 'awareness',
    'introspection', 'worldview', 'purpose', 'acceptance', 'embrace', 'tolerance', 'appreciation', 'journey',
    'memorable', 'lessons', 'connection', 'exploration', 'understanding', 'revelation', 'personal',
    'expansion', 'transformation', 'experience', 'new horizons', 'influence'
  ];
