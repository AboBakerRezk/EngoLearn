...
class WritingSection32 extends StatefulWidget {
  @override
  _WritingSection32State createState() => _WritingSection32State();
}

class _WritingSection32State extends State<WritingSection32>
...
// Function to save progress levels including bottleFillLevel to SharedPreferences
  ...
  void _checkRelevance() {
    List<String> topicKeywords = [
      // الكلمات المضافة عن التأثيرات النفسية لوسائل التواصل الاجتماعي على تقدير الذات:
      'social media',
      'self-esteem',
      'mental health',
      'online presence',
      ...
      'virtual self-promotion',
      'like and share culture',
      'online validation cycle',
      'virtual friends vs real life',
      ...
      'personal branding',
      'online persona distortion',
      'content creation stress',
      'digital community',
      'peer influence on self-worth',
