...
class WritingSection42 extends StatefulWidget {
  @override
  _WritingSection42State createState() => _WritingSection42State();
}

class _WritingSection42State extends State<WritingSection42>    with SingleTickerProviderStateMixin {
  // Variables
  String userWriting = '';
...
// Function to save progress levels including bottleFillLevel to SharedPreferences
  ...
  void _checkRelevance() {
    List<String> topicKeywords = [
      // الكلمات المتعلقة بتعقيد العلاقات الإنسانية في العصر الرقمي:
      'human relationships',
      'digital age',
      ...
      'relationship boundaries in the digital world',
      'technology and emotional distance',
      'relationship satisfaction',
      'social media pressures',
      'online relationship etiquette',
      'digital relationships and mental health',
      'long-distance relationships in the digital age',
      'social isolation',
      'relationship misunderstandings',
      'online connection vs in-person connection',
      'virtual vs physical interaction',
      'digital dating culture',
      'privacy in digital relationships',
      'online identity and relationships',
      'social media and self-expression',
      'social media addiction',
      'emotional availability in digital relationships',
      'managing online relationships',
      'relationship burnout',
      'technology and communication breakdown',
      'digital presence in relationships',
      'instant messaging and relationships',
      'online trust issues',
      'communication barriers',
      'relationship dynamics online',
      'social comparison in relationships',
      'digital distractions',
      'internet relationship culture',
      'authentic connections',
      'cyber relationships',
      'communication overload',
      'online support systems',
      'digital dependency in relationships',
      'virtual love',
      'online intimacy challenges',
      ...
      'online infidelity',
      'emotional distancing through technology',
      'relationship expectations in the digital world',
      'online vs offline communication',
      'social media validation in relationships',
      'technology and relationship management',
      'online relationship success',
      'emotional connection through screens',
      'relationships and online presence',
      'social media-induced stress',
      'digital communication etiquette',
      'relationship growth in digital spaces',
      'online behavior and relationships',
      'emotional dependency on digital platforms',
      'relationship norms in the digital era',
      'relationship breakdown in the digital world',
      'online relationship struggles',
      'social media and trust issues',
      'communication gaps online',
      'digital dating apps',
      'digital relationship management tools',
      'social media influence on love',
      'online connection authenticity',
      'virtual relationship dynamics',
      'personal relationships in the digital era',
      'relationship quality in digital interactions',
      'texting in relationships',
      'technology and emotional connection',
      'emotional support in digital spaces',
      'social media and emotional expression',
      'digital boundaries',
      'privacy and trust in digital communication',
      'relationships and digital footprints',
      'managing digital relationships',
      'disconnect in digital communication',
      'social media and relationship satisfaction',
      'online relationship etiquette challenges',
      'communication overload in relationships',
      'virtual vs real-life relationship maintenance',
      'digital love and trust',
      'relationship conflict in the digital world',
      'technology-induced distance in relationships',
      'virtual vs real-life communication styles',
      'social media and emotional detachment',
      'virtual connection overload',
      'relationship authenticity online',
      'digital communication fatigue',
      'online relationships and mental health',
      'emotional vulnerability in digital communication',
      'instant gratification in relationships',
      'online emotional connection',
      'long-distance digital relationships',
      'over-reliance on technology in relationships',
      'social media validation',
      'relationship detachment through digital interaction',
      'technology and relationship quality',
      'emotional connection challenges',
      'technology-mediated relationships',
      'relationship complexity online',
      'miscommunication in online relationships',
      'online relationship behaviors',
      'virtual vs in-person emotional connection',
      'relationship success in digital age',
      'digital communication effectiveness',
      'relationship conflicts through text',
      'online relationship vulnerability',
      'emotional disconnect in digital interactions',
      'digital romance',
      'relationship authenticity challenges online',
      'maintaining relationships through technology',
      'digital trust building',
      'cyber emotional connections',
      'digital communication misunderstandings',
      'social media influence on intimacy',
      'emotional bonding in digital relationships',
      'technology and relational communication',
      'virtual presence in relationships',
      'over-communication online',
      'digital love dynamics',
      'virtual communication barriers',
      'social media influence on romantic relationships',
      'relationship conflict resolution online',
      'emotional complexity in virtual interactions',
      'online jealousy',
      'communication technology and relationships',
      'relationship satisfaction and social media',
      'digital emotional availability',
      'texting vs talking in relationships',
      'social media and personal boundaries',
      'emotional needs in online relationships',
      'relationship breakdown due to technology',
      'digital relationships and authenticity',
      'virtual love challenges',
      'relationship fatigue from online interactions',
      'impact of digital communication on intimacy',
      'over-dependence on online communication',
      'relationship quality and social media use',
      'digital intimacy barriers',
      'social media comparison in relationships',
      'emotional connection in virtual relationships',
      'communication challenges in digital relationships',
      'virtual trust issues',
      'online emotional disconnection',
      'cyber communication etiquette',
      'online relationship dilemmas',
      'communication overload in digital relationships',
    ];
      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: [
            SizedBox(height: 20),
            Text(
              'The Complexity of Human Relationships in the Digital Age.',
