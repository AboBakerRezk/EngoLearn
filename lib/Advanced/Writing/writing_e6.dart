...
List<String> dailySentences = [
  ...
  'ما هو أكبر درس تعلمته في الحياة؟',
  'هل تحب العمل في بيئة سريعة؟',
  'كيف تحافظ على لياقتك البدنية؟',
  'ما هو أكثر شيء يشغلك هذه الأيام؟',
  'ما هو أفضل نصيحة تلقيتها؟',
  'هل تفضل العمل بمفردك؟',
  'كيف تحافظ على توازنك بين العمل والحياة؟',
  'ما هو فيلمك المفضل؟',
  'ما هو نوع الكتب التي تحب قراءتها؟',
  'كيف تقضي وقت فراغك؟',
  'ما هو هدفك الأكبر في الحياة؟',
  'هل تحب العمل الجماعي؟',
  'ما هي أكبر إنجازاتك؟',
  'كيف تحافظ على تحفيزك؟',
  'ما هو الشيء الذي تود تحسينه في نفسك؟',
  'هل تحب المغامرات؟',
  'ما هو أكثر مكان تود زيارته؟',
  'ما هو طعامك الصحي المفضل؟',
  'كيف تسترخي بعد يوم طويل؟',
];
...
List<String> correctTranslations = [
  ...
  'What’s the top place you want to visit?',
...
class WritingSection6 extends StatefulWidget {
  @override
  _WritingSection6State createState() => _WritingSection6State();
}

class _WritingSection6State extends State<WritingSection6>  {
  String userWriting = '';
