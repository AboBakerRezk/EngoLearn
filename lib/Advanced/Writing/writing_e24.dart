...
class WritingSections24 extends StatefulWidget {
  @override
  _WritingSections24State createState() => _WritingSections24State();
}

class _WritingSections24State extends State<WritingSections24> {
  ...
  String title = 'The Role of Empathy in Our Lives'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'understanding', 'compassion', 'connection', 'kindness', 'support', 'communication', 'emotional intelligence',
    'relationships', 'trust', 'validation', 'listening', 'respect', 'care', 'awareness', 'inclusion',
    'forgiveness', 'tolerance', 'solidarity', 'humanity', 'insight', 'benevolence', 'collaboration',
    'well-being', 'altruism', 'reconciliation', 'harmony', 'community', 'appreciation', 'sympathy',
    'social skills', 'helpfulness', 'grace', 'nurturing', 'shared experiences', 'perspective',
    'growth', 'understanding', 'compassionate action', 'connections', 'unity', 'support systems',
    'love', 'acceptance', 'dialogue', 'emotion', 'reciprocity', 'engagement', 'influence',
    'responsibility', 'care', 'outreach'
  ];
