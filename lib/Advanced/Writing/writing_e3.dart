...
List<String> dailySentences = [
  'هل لديك حيوان أليف؟',
  'ما هو أفضل وقت لليوم بالنسبة لك؟',
  'هل تحب الموسيقى؟',
  ...
  'ما هي لغتك المفضلة؟',
  'ما هو مشروبك المفضل؟',
  'هل تفضل العمل من المنزل؟',
  'ما هي أهم أولوياتك في الحياة؟',
  'ما هو طبقك المفضل؟',
  'هل تحب القراءة قبل النوم؟',
  'هل تفضل الليل أم النهار؟',
  'ما هو حلمك الكبير؟',
  'هل تجيد العزف على آلة موسيقية؟',
  'متى كان آخر مرة مارست فيها الرياضة؟',
  'هل تحب التسوق؟',
  'ما هو أكبر إنجاز لك؟',
  'هل تحب مشاهدة الأفلام في السينما؟',
...
List<String> correctTranslations = [
  ...
  'Do you like watching movies in the cinema?',
...
class WritingSection3 extends StatefulWidget {
  @override
  _WritingSection3State createState() => _WritingSection3State();
}

class _WritingSection3State extends State<WritingSection3>  {
  String userWriting = '';
