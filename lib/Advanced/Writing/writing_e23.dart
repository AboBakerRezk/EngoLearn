...
class WritingSections23 extends StatefulWidget {
  @override
  _WritingSections23State createState() => _WritingSections23State();
}

class _WritingSections23State extends State<WritingSections23> {
  ...
  String title = 'Cultural Differences I Encountered Abroad'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'diversity', 'tradition', 'customs', 'values', 'communication', 'food', 'etiquette', 'beliefs',
    'perspectives', 'behavior', 'language', 'social norms', 'practices', 'understanding', 'adaptation',
    'experiences', 'respect', 'interactions', 'identities', 'community', 'celebrations', 'differences',
    'insight', 'curiosity', 'integration', 'acceptance', 'globalization', 'stereotypes',
    'relationships', 'open-mindedness', 'empathy', 'boundaries', 'attitudes', 'exploration',
    'cultural exchange', 'traditions', 'learning', 'awareness', 'history', 'perspective',
    'connection', 'discovery', 'interaction', 'impact', 'acceptance', 'identity',
    'adventure', 'challenge', 'foreign', 'immersive', 'influence', 'social dynamics'
  ];
