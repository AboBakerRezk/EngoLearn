...
List<String> dailySentences = [
  ...
  'ما هو حلمك الأكبر؟',
  'ما هي قوتك الأساسية؟',
  'هل تعتقد أن العمل الجاد دائمًا يؤتي ثماره؟',
  'ما هو أكثر شيء يشعرك بالامتنان؟',
  'كيف تتعامل مع النقد؟',
  'ما هي أهدافك المهنية؟',
  'ما هو أفضل وقت لقضاء العطلات بالنسبة لك؟',
  'ما هو الشيء الذي ترغب في تحسينه في نفسك؟',
  'هل تحب التعلم الذاتي؟',
  'ما هي نصيحتك لشخص يبدأ حياته المهنية؟',
  'ما هو أفضل شيء تعلمته هذا العام؟',
  'ما الذي يحفزك في حياتك اليومية؟',
  'هل تؤمن بقدرتك على تحقيق النجاح؟',
  'ما هو أكبر إنجاز في حياتك؟',
  'كيف تحافظ على تركيزك في العمل؟',
  'ما هو المبدأ الذي تحاول العيش به؟',
  'ما هي هوايتك المفضلة لتخفيف التوتر؟',
];
...
List<String> correctTranslations = [
  ...
  'Do you believe hard work always pays off?',
  'What are you most grateful for?',
  'How do you handle criticism?',
  'What are your career goals?',
  'What’s the best time for holidays for you?',
  'What’s one thing you want to improve in yourself?',
  'Do you enjoy self-learning?',
  ...
  'Do you believe in your ability to achieve success?',
  'What’s the greatest achievement in your life?',
  'How do you stay focused at work?',
  'What’s the principle you try to live by?',
  'What’s your favorite hobby to relieve stress?',
];
...
class WritingSection7 extends StatefulWidget {
  @override
  _WritingSection7State createState() => _WritingSection7State();
}

class _WritingSection7State extends State<WritingSection7>  {
  String userWriting = '';
