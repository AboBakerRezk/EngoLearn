...
class WritingSections28 extends StatefulWidget {
  @override
  _WritingSections28State createState() => _WritingSections28State();
}

class _WritingSections28State extends State<WritingSections28> {
  ...
  String title = 'The Evolution of My Political Views'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'transformation', 'awareness', 'values', 'ideology', 'beliefs', 'engagement', 'experience',
    'debate', 'understanding', 'activism', 'reflection', 'influence', 'dialogue', 'perspective',
    'growth', 'education', 'change', 'identity', 'responsibility', 'opinions', 'analysis',
    'history', 'context', 'discourse', 'culture', 'critical thinking', 'participation',
    'community', 'reform', 'advocacy', 'social justice', 'consciousness', 'persuasion',
    'rights', 'freedom', 'global issues', 'activism', 'mobilization', 'political spectrum',
    'solidarity', 'integration', 'vision', 'consensus', 'values', 'empowerment',
    'civic duty', 'self-awareness', 'philosophy', 'values', 'representation', 'decision-making'
  ];
