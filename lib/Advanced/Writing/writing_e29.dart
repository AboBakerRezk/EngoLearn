...
class WritingSections29 extends StatefulWidget {
  @override
  _WritingSections29State createState() => _WritingSections29State();
}

class _WritingSections29State extends State<WritingSections29> {
  ...
  String title = 'The Ethics of Technology in Our Society'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'responsibility', 'impact', 'privacy', 'security', 'transparency', 'innovation', 'accessibility',
    'accountability', 'sustainability', 'equity', 'justice', 'data', 'consent', 'trust',
    'social responsibility', 'governance', 'bias', 'digital divide', 'inclusion', 'ethics',
    'regulation', 'collaboration', 'misuse', 'freedom', 'autonomy', 'surveillance',
    'technology', 'human rights', 'interdependence', 'well-being', 'environment', 'communication',
    'identity', 'responsiveness', 'development', 'corporate ethics', 'impact assessment',
    'community', 'innovation', 'social impact', 'values', 'advocacy', 'consequences',
    'relationship', 'integrity', 'responsibility', 'philosophy', 'wellness', 'trustworthiness'
  ];
