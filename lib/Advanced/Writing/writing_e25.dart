...
class WritingSections25 extends StatefulWidget {
  @override
  _WritingSections25State createState() => _WritingSections25State();
}

class _WritingSections25State extends State<WritingSections25> {
  ...
  String title = 'A Significant Event That Shaped My Values'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'transformation', 'experience', 'insight', 'growth', 'reflection', 'understanding', 'principles',
    'beliefs', 'lessons', 'impact', 'identity', 'character', 'decisions', 'change', 'awareness',
    'values', 'influence', 'emotional', 'memories', 'perspective', 'cultural', 'relationship',
    'moral', 'responsibility', 'self-discovery', 'journey', 'motivation', 'purpose',
    'connection', 'legacy', 'commitment', 'resilience', 'self-awareness', 'inspiration',
    'attitude', 'dedication', 'community', 'meaning', 'acceptance', 'support', 'advocacy',
    'empowerment', 'integration', 'vision', 'maturity', 'understanding', 'unity',
    'direction', 'choices', 'impact'
  ];
