...
class WritingSections13 extends StatefulWidget {
  @override
  _WritingSections13State createState() => _WritingSections13State();
}

class _WritingSections13State extends State<WritingSections13> {
  ...
  String title = 'My Ideal Career'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'passion', 'dream', 'aspiration', 'goals', 'success', 'fulfillment', 'profession', 'growth', 'challenges',
    'ambition', 'inspiration', 'innovation', 'leadership', 'creativity', 'skills', 'opportunities', 'networking',
    'experience', 'dedication', 'balance', 'lifestyle', 'satisfaction', 'collaboration', 'learning', 'development',
    'vision', 'values', 'impact', 'purpose', 'career path', 'exploration', 'training', 'mentorship', 'advancement',
    'responsibility', 'job satisfaction', 'work-life balance', 'commitment', 'teamwork', 'achievement', 'focus',
    'commitment', 'flexibility', 'self-improvement', 'adaptability', 'interests', 'influence', 'contribution',
    'potential', 'challenges', 'rewarding', 'reputation', 'stability', 'expertise', 'lifetime', 'success',
    'sustainable', 'dynamic', 'engagement', 'pursuit', 'innovation', 'values', 'determination', 'drive',
    'motivation', 'visionary', 'future', 'goal-oriented', 'exploration'
  ];
