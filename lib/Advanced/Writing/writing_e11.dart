...
class WritingSections11 extends StatefulWidget {
  @override
  _WritingSections11State createState() => _WritingSections11State();
}

class _WritingSections11State extends State<WritingSections11> {
  ...
  String title = 'The Most Memorable Day of My Life'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'celebration', 'joy', 'happiness', 'memory', 'achievement', 'family', 'friends', 'milestone', 'wedding', 'graduation',
    'birthday', 'success', 'smile', 'tears', 'emotion', 'love', 'pride', 'special', 'unforgettable', 'moment', 'surprise',
    'gift', 'accomplishment', 'victory', 'dream', 'realized', 'honor', 'reward', 'party', 'fun', 'laughter', 'gratitude',
    'blessing', 'cherished', 'event', 'anniversary', 'bond', 'reunion', 'togetherness', 'journey', 'life-changing',
    'memories', 'reflection', 'time', 'celebrate', 'milestones', 'legacy', 'success', 'fulfillment', 'achievement',
    'bravery', 'first', 'love', 'support', 'overcome', 'challenges', 'growth', 'personal', 'experience', 'memorable',
    'highlight', 'milestone', 'gratitude', 'reflection', 'accomplishments', 'cherished', 'unexpected', 'rewarding',
    'bonding', 'shared', 'emotional', 'joyous', 'incredible', 'mark', 'special', 'proud', 'fulfilled', 'journey',
    'significant', 'life', 'appreciation', 'memorable'
  ];
...
// دالة لحساب Levenshtein Distance بين كلمتين
  ...
  void _checkWordMatch() {
    ...
    if (matchingWords >= 30) {
      ...
      wordMatchPercentage = 50.0;
    } else {
      wordMatchPercentage = (matchingWords / 30) * 100;
    }
  ...
  void _analyzeWritingStyle() {
    styleFeedback = 'أسلوب الكتابة رسمي ومنظم.';
  }

  void _analyzeClarity() {
    clarityFeedback =
    'بعض الجمل معقدة ويمكن تبسيطها لتحسين الوضوح.';
  }

  void _analyzeCoherence() {
    coherenceFeedback =
    'الأفكار في كتابتك متماسكة بشكل عام، ولكن يمكن تحسين الانتقالات بين الفقرات.';
  }
