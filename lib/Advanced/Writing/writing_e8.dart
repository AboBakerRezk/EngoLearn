...
List<String> dailySentences = [
  'ما هو الشيء الذي تتمنى تغييره في العالم؟',
  'كيف تتخذ قراراتك المهمة؟',
  'ما هو أكثر شيء يجعلك سعيدًا؟',
  'هل تؤمن بالقدر؟',
  'ما هو شعارك في الحياة؟',
  'هل لديك قدوة؟',
  'ما هي أهم صفات الشخص الناجح؟',
  'كيف تتغلب على الفشل؟',
  'ما هو أهم شيء تعلمته من أخطائك؟',
  ...
  'ما هي قيمة الصداقة في حياتك؟',
  'هل تحب العمل في فريق أم بشكل فردي؟',
  'ما هي هوايتك المفضلة؟',
];

List<String> correctTranslations = [
  'What’s one thing you wish to change in the world?',
  'How do you make important decisions?',
  'What makes you the happiest?',
  'Do you believe in fate?',
  'What’s your motto in life?',
  'Do you have a role model?',
  'What are the key traits of a successful person?',
...
class WritingSection8 extends StatefulWidget {
  @override
  _WritingSection8State createState() => _WritingSection8State();
}

class _WritingSection8State extends State<WritingSection8>  {
  String userWriting = '';
