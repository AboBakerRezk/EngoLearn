...
class WritingSections27 extends StatefulWidget {
  @override
  _WritingSections27State createState() => _WritingSections27State();
}

class _WritingSections27State extends State<WritingSections27> {
  ...
  String title = 'The Influence of Literature on My Perspective'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'insight', 'imagination', 'empathy', 'understanding', 'interpretation', 'narrative', 'reflection',
    'wisdom', 'identity', 'experience', 'culture', 'inspiration', 'exploration', 'growth',
    'perspective', 'creativity', 'connection', 'ideas', 'themes', 'expression', 'analysis',
    'impression', 'values', 'diversity', 'critique', 'thought-provoking', 'enlightenment',
    'escape', 'transformation', 'dialogue', 'impact', 'mood', 'genre', 'exploration',
    'understanding', 'awareness', 'experience', 'character', 'motivation', 'depth',
    'journey', 'literary', 'adventure', 'tradition', 'storytelling', 'imagination',
    'cultural exchange', 'reflection', 'memory', 'revelation', 'connection', 'wisdom'
  ];
