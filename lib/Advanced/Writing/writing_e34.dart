...
class WritingSection34 extends StatefulWidget {
  @override
  _WritingSection34State createState() => _WritingSection34State();
}

class _WritingSection34State extends State<WritingSection34>    with SingleTickerProviderStateMixin {
  // Variables
  String userWriting = '';
...
// Function to save progress levels including bottleFillLevel to SharedPreferences
  ...
  void _checkRelevance() {
    List<String> topicKeywords = [
      // الكلمات المتعلقة بتأثير تغير المناخ على الاقتصاد العالمي:
      'climate change',
      'global economies',
      'economic impact',
      'sustainability',
      ...
      'climate risks to economies',
      'environmental conservation',
      'natural capital',
      'climate impact on industries',
