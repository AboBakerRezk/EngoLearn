...
class WritingSections30 extends StatefulWidget {
  @override
  _WritingSections30State createState() => _WritingSections30State();
}

class _WritingSections30State extends State<WritingSections30> {
  ...
  String title = 'The Art of Effective Communication'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'clarity', 'listening', 'empathy', 'expression', 'understanding', 'dialogue', 'persuasion',
    'interaction', 'feedback', 'nonverbal', 'articulation', 'confidence', 'engagement',
    'message', 'connection', 'tone', 'clarity', 'rapport', 'assertiveness', 'diplomacy',
    'influence', 'context', 'cultural awareness', 'interpersonal', 'collaboration',
    'negotiation', 'public speaking', 'presentation', 'artistry', 'transparency',
    'interpretation', 'relationships', 'authenticity', 'perspective', 'body language',
    'communication styles', 'expression', 'assertiveness', 'information', 'effectiveness',
    'creativity', 'compassion', 'motivation', 'collaboration', 'trust', 'listening skills'
  ];
