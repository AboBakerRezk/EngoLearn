...
class WritingSections19 extends StatefulWidget {
  @override
  _WritingSections19State createState() => _WritingSections19State();
}

class _WritingSections19State extends State<WritingSections19> {
  ...
  String title = ' A Role Model I Admire'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'inspiration', 'leadership', 'values', 'integrity', 'courage', 'dedication', 'achievement', 'mentor',
    'wisdom', 'influence', 'character', 'empathy', 'motivation', 'passion', 'vision', 'resilience', 'success',
    'commitment', 'influence', 'guidance', 'authenticity', 'support', 'strength', 'humility', 'service',
    'dedication', 'impact', 'influence', 'compassion', 'advocacy', 'empowerment', 'role model',
    'innovation', 'growth', 'transformation', 'determination', 'persistence', 'nurturing', 'positivity',
    'influence', 'development', 'characteristics', 'responsibility', 'inspiration', 'example',
    'achievement', 'legacy', 'values', 'trustworthiness', 'belief', 'courage', 'encouragement',
    'kindness', 'qualities', 'learning', 'celebration', 'advancement'
  ];
