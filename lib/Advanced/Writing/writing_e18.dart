...
class WritingSections18 extends StatefulWidget {
  @override
  _WritingSections18State createState() => _WritingSections18State();
}

class _WritingSections18State extends State<WritingSections18> {
  ...
  String title = 'The Importance of Mental Health'; // عنوان القصة باللغة العربية
  ...
  List<String> relatedWords = [
    'well-being', 'awareness', 'support', 'self-care', 'resilience', 'stress management', 'therapy', 'emotional',
    'mindfulness', 'balance', 'mental wellness', 'treatment', 'self-esteem', 'anxiety', 'depression', 'recovery',
    'community', 'understanding', 'coping', 'growth', 'happiness', 'fulfillment', 'prevention', 'stigma',
    'education', 'connection', 'mindset', 'empathy', 'communication', 'healing', 'nurturing', 'compassion',
    'relationships', 'resources', 'tools', 'empowerment', 'vulnerability', 'expression', 'reflection',
    'self-awareness', 'positivity', 'psychology', 'emotional health', 'holistic', 'encouragement', 'development',
    'clarity', 'boundaries', 'adaptability', 'wellness', 'safety', 'support systems', 'personal growth',
    'balance', 'life satisfaction', 'self-acceptance'
  ];
